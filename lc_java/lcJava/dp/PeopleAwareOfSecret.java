...
public class PeopleAwareOfSecret {
    ...
    public static void main(String[] args) {
        PeopleAwareOfSecret solution = new PeopleAwareOfSecret();
        
        // 测试用例1: n=6, delay=2, forget=4
        System.out.println("Test Case 1: " + solution.peopleAwareOfSecret(6, 2, 4)); // 预期输出: 5
        
        // 测试用例2: n=4, delay=1, forget=3
        System.out.println("Test Case 2: " + solution.peopleAwareOfSecret(4, 1, 3)); // 预期输出: 6
        
        // 测试用例3: n=10, delay=2, forget=5
        System.out.println("Test Case 3: " + solution.peopleAwareOfSecret(10, 2, 5));
    }
}
